...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\IUG-Training\Week 13\task12\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\IUG-Training\\Week 13\\task12\\public\\storage','logging.default',
...
'web','api','admin','instructor','student',
'auth','auth.basic','auth.session','cache.headers','can',
'guest','password.confirm','precognitive','signed','throttle',
'verified','role','permission','role_or_permission','essential.data',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','home','courses.public','courses.show',
'about','contact','contact.store','register',
'login','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm','password.update','logout','profile.edit','profile.update',
'profile.avatar.update','profile.password.update','profile.settings','profile.settings.update','notifications.index',
'notifications.read','notifications.read-all','notifications.destroy','notifications.clear-all','messages.inbox',
'messages.sent','messages.compose','messages.send','messages.conversation','messages.send-reply',
'messages.new-messages','messages.read','messages.send-to-admin','messages.destroy','contacts.index',
'contacts.search','dashboard','learning-path.index','learning-path.show','learning-path.delete',
'learning-path.start','learning-path.generate','learning-path.sessions.upcoming','learning-path.sessions.past','courses.my-courses',
'courses.progress','courses.registration','courses.register.process','courses.free-enroll','courses.request-certificate',
'courses.sessions.index','courses.sessions.show','courses.sessions.join','courses.materials.index','courses.materials.show',
'courses.materials.download','courses.assignments.index','courses.assignments.show','courses.assignments.submit','courses.assignments.download',
'courses.reviews.index','courses.reviews.store','courses.reviews.edit','courses.reviews.update','courses.reviews.destroy',
'courses.reviews.helpful','courses.reviews.not-helpful','wishlist.index','wishlist.add','wishlist.remove',
'wishlist.priority','wishlist.reminder','wishlist.clear-reminder','wishlist.enroll','onboarding.complete',
'admins.list','admin.dashboard','admin.menu','admin.courses.index','admin.courses.create',
'admin.courses.store','admin.courses.edit','admin.courses.update','admin.courses.destroy','admin.courses.toggle-featured',
'admin.courses.toggle-active','admin.courses.enrollments','admin.reviews.index','admin.reviews.show','admin.reviews.toggle-approval',
'admin.reviews.destroy','admin.reviews.bulk-approve','admin.reviews.course','admin.students.index','admin.students.create',
'admin.students.store','admin.students.show','admin.students.edit','admin.students.update','admin.students.destroy',
'admin.students.notes.store','admin.students.notes.index','admin.students.notes.edit','admin.students.notes.update','admin.students.notes.destroy',
'admin.students.enrollments','admin.students.enroll-to-course','admin.students.enrollments.destroy','admin.students.enrollments.status','admin.students.learning-path.generate',
'admin.students.bulk-action','admin.students.send-message','admin.staff.index','admin.staff.create','admin.staff.store',
'admin.staff.show','admin.staff.edit','admin.staff.update','admin.staff.destroy','admin.staff.verify-email',
'admin.staff.reset-password','admin.staff.toggle-status','admin.staff.bulk-action','admin.enrollments.index','admin.enrollments.create',
'admin.enrollments.store','admin.enrollments.show','admin.enrollments.edit','admin.enrollments.update','admin.enrollments.destroy',
'admin.enrollments.update-status','admin.enrollments.update-progress','admin.enrollments.approve','admin.enrollments.reject','admin.enrollments.bulk-action',
'admin.analytics.index','admin.analytics.courses','admin.analytics.export-courses','admin.analytics.students','admin.analytics.export-students',
'admin.analytics.revenue','admin.analytics.export-revenue','admin.analytics.enrollments','admin.analytics.export-enrollments','admin.analytics.peak-hours',
'admin.analytics.export-peak-hours','admin.categories.index','admin.categories.store','admin.categories.update','admin.categories.destroy',
'instructor.dashboard','instructor.courses','instructor.course.check-status','instructor.course-students','instructor.course-students.report',
'instructor.courses.create','instructor.courses.store','instructor.courses.edit','instructor.courses.update','instructor.courses.destroy',
'instructor.certificate','instructor.student.progress','instructor.course.analytics','instructor.students.bulk-email','instructor.course.sessions.ajax-update',
'instructor.course.sessions.index','instructor.course.sessions.store','instructor.course.sessions.update','instructor.course.sessions.destroy','instructor.course.sessions.share-meeting',
'instructor.course.sessions.share-recording','instructor.course.sessions.attendance','instructor.course.bulk.progress','instructor.course.bulk.attendance','instructor.course.bulk.message',
'instructor.course.bulk.share-material','instructor.course.assignments.index','instructor.course.assignments.create','instructor.course.assignments.store','instructor.course.assignments.edit',
'instructor.course.assignments.update','instructor.course.assignments.destroy','instructor.course.assignments.submissions','instructor.course.assignments.grade','instructor.course.materials.index',
'instructor.course.materials.create','instructor.course.materials.store','instructor.course.materials.edit','instructor.course.materials.update','instructor.course.materials.destroy',
'instructor.course.materials.show','instructor.course.materials.reorder','instructor.calendar.session.update','instructor.calendar.assignment.update','instructor.calendar.events',
'api.notifications.count','api.notifications.latest','api.analytics.chart-data','api.analytics.quick-stats','api.analytics.filter-data',
'storage.local',);
        registerArgumentsSet('views', 
'admin.analytics.courses','admin.analytics.courses-pdf','admin.analytics.enrollments','admin.analytics.enrollments-pdf','admin.analytics.index',
'admin.analytics.peak-hours','admin.analytics.peak-hours-pdf','admin.analytics.revenue','admin.analytics.revenue-pdf','admin.analytics.students',
'admin.analytics.students-pdf','admin.categories.index','admin.courses.create','admin.courses.edit','admin.courses.enrollments',
'admin.courses.index','admin.dashboard','admin.enrollments.create','admin.enrollments.edit','admin.enrollments.index',
'admin.enrollments.show','admin.menu','admin.reviews.index','admin.reviews.partials._review-card','admin.reviews.show',
'admin.staff.create','admin.staff.edit','admin.staff.index','admin.staff.show','admin.students.create',
'admin.students.edit','admin.students.enrollments','admin.students.index','admin.students.show','auth.confirm-password',
...
'components.responsive-nav-link','components.secondary-button','components.text-input','errors.401','errors.403',
'errors.404','errors.419','errors.429','errors.500','errors.503',
'instructor.certificate','instructor.course-students','instructor.courses','instructor.courses.assignments.create','instructor.courses.assignments.edit',
'instructor.courses.assignments.index','instructor.courses.assignments.submissions','instructor.courses.create','instructor.courses.edit','instructor.courses.materials.create',
'instructor.courses.materials.edit','instructor.courses.materials.index','instructor.courses.materials.show','instructor.dashboard','instructor.student-progress',
'instructor.students-report','layouts.app','layouts.guest','layouts.navigation','profile.edit',
'profile.settings','public.about','public.contact','public.course-details','public.courses',
'public.index','public.registration','user.assignments.index','user.assignments.show','user.contacts.index',
'user.course-progress','user.dashboard','user.learning-path.index','user.learning-path.partials._course-card','user.learning-path.partials._milestone-notification',
'user.learning-path.partials._path-timeline','user.learning-path.partials._progress-stats','user.learning-path.partials._recommendations','user.learning-path.show','user.materials.index',
'user.materials.show','user.messages.conversation','user.messages.inbox','user.messages.sent','user.my-courses',
'user.notifications','user.partials.onboarding','user.sessions.index','user.sessions.past','user.sessions.show',
'user.sessions.upcoming','user.wishlist','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.xampp.htdocs.IUG-Training.Week 13.task12.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
