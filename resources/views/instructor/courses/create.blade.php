    ...
    <div class="instructor-container">
        <div class="page-header">
            ...
            <div class="warning-badge">
                ...
                You're creating this course as an instructor
            </div>
        </div>

        <form action="{{ route('instructor.courses.store') }}" method="POST" enctype="multipart/form-data" class="form-layout">
            @csrf
            ...
            <div class="form-card">
                ...
                <div class="instructor-info">
                    ...
                    <div class="instructor-details">
                        ...
                        <p>{{ Auth::user()->email }}</p>
                        <small>You will be listed as the instructor for this course</small>
                    </div>
                </div>
