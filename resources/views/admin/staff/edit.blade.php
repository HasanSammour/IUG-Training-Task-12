...
@section('title', 'Edit Staff - Shifra Admin')
        ...
        <form action="{{ route('admin.staff.update', $staff) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="avatar-section">
                <div class="avatar-wrapper">
                    @if($staff->avatar && \Storage::disk('public')->exists($staff->avatar))
                        <img src="{{ Storage::url($staff->avatar) }}" alt="{{ $staff->name }}" class="avatar-image" id="avatarPreview">
                    @else
                ...
                <div class="avatar-info">
                    ...
                    <p>
                        @foreach($staff->roles as $role)
                            <span class="role-badge {{ $role->name }}" style="display: inline-block; margin-right: 5px;">
            ...
            @if($staff->hasRole('admin') && \App\Models\User::role('admin')->count() <= 1)
                <div class="admin-warning">
                    ...
                    <div>
                        <strong>Warning:</strong> This is the last admin account. Changing role or deactivating may lock you out of admin access.
                    </div>
                </div>
            @endif
            ...
            <div class="form-section">
                ...
                <div class="role-selector">
                    ...
                    <div class="role-options">
                        <!-- Admin Option -->
                        <div class="role-card @if(old('role', $currentRole) == 'admin') selected @endif" 
                        ...
                        <!-- Instructor Option -->
                        <div class="role-card @if(old('role', $currentRole) == 'instructor') selected @endif" 
                             onclick="selectRole('instructor')" id="roleInstructor">
                    ...
                    <input type="hidden" name="role" id="selectedRole" value="{{ old('role', $currentRole) }}">
                    @error('role')
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="bio" class="form-textarea @error('bio') error @enderror" 
                              placeholder="Brief description about the staff member...">{{ old('bio', $staff->bio) }}</textarea>
                    @error('bio')
                        <div class="error-message">
                            <i class="fas fa-exclamation-circle"></i> {{ $message }}
                        </div>
...
<form id="removeAvatarForm" action="{{ route('admin.staff.update', $staff) }}" method="POST" style="display: none;">
    @csrf
    @method('PUT')
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (removeAvatarBtn) {
            removeAvatarBtn.addEventListener('click', function() {
                Swal.fire({
                    title: 'Remove Avatar?',
                    text: 'Are you sure you want to remove this staff member\'s profile picture?',
                    icon: 'warning',
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                ...
                const roleInput = document.getElementById('selectedRole').value;
