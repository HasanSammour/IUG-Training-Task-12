...
@section('title', 'Edit Course - Shifra Admin')
...
<div class="page-container">
    <div class="admin-container">
        ...
        <form action="{{ route('admin.courses.update', $course) }}" method="POST" enctype="multipart/form-data" class="form-layout">
            @csrf
            @method('PUT')
                            ...
                            <select id="instructor_id" name="instructor_id" class="form-select" required>
                                ...
                                @foreach($instructors as $instructor)
                                    <option value="{{ $instructor->id }}" 
                                        {{ (old('instructor_id', $currentInstructor?->id) == $instructor->id) ? 'selected' : '' }}>
                    ...
                    <div class="grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="total_students" name="total_students" class="form-input" 
                                   min="0" value="{{ old('total_students', $course->total_students) }}">
